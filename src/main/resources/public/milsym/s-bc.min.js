...
this._friendlyUnitLineColor=friendlyUnitLineColor;},getHostileUnitLineColor:function(){return _hostileUnitLineColor;},setHostileUnitLineColor:function(hostileUnitLineColor){if(hostileUnitLineColor!=null)
this._hostileUnitLineColor=hostileUnitLineColor;},getNeutralUnitLineColor:function(){return _neutralUnitLineColor;},setNeutralUnitLineColor:function(neutralUnitLineColor){if(neutralUnitLineColor!=null)
this._neutralUnitLineColor=neutralUnitLineColor;},getUnknownUnitLineColor:function(){return _unknownUnitLineColor;},setUnknownUnitLineColor:function(unknownUnitLineColor){if(unknownUnitLineColor!=null)
this._unknownUnitLineColor=unknownUnitLineColor;},getFriendlyGraphicLineColor:function(){return _friendlyGraphicLineColor;},setFriendlyGraphicLineColor:function(friendlyGraphicLineColor){if(friendlyGraphicLineColor!=null)
this._friendlyGraphicLineColor=friendlyGraphicLineColor;},getHostileGraphicLineColor:function(){return _hostileGraphicLineColor;},setHostileGraphicLineColor:function(hostileGraphicLineColor){if(hostileGraphicLineColor!=null)
this._hostileGraphicLineColor=hostileGraphicLineColor;},getNeutralGraphicLineColor:function(){return _neutralGraphicLineColor;},setNeutralGraphicLineColor:function(neutralGraphicLineColor){if(neutralGraphicLineColor!=null)
this._neutralGraphicLineColor=neutralGraphicLineColor;},getUnknownGraphicLineColor:function(){return _unknownGraphicLineColor;},setUnknownGraphicLineColor:function(unknownGraphicLineColor){if(unknownGraphicLineColor!=null)
...
hqBounds=new SO.Rectangle(pt1HQ.getX(),pt1HQ.getY(),2,pt2HQ.getY()-pt1HQ.getY());imageBounds.union(hqBounds);centerPoint.setLocation(pt2HQ.getX(),pt2HQ.getY());}
...
length=bounds.getHeight();var dx2,dy2,x1,y1,x2,y2;x1=Math.round(center.getX());y1=Math.round(center.getY());pt1=new SO.Point(x1,y1);var scheme=symbolID.charAt(0);if(SymbolUtilities.isNBC(symbolID)||(scheme==='S'&&symbolID.charAt(2)===("G"))||scheme==='O'||scheme==='E')
